...
async def get_transport(sel_transport, service_name, check_hostname):
    try:
        ...
        if (sel_transport == 'http'):
            ...
            cert_path = os.path.abspath('D:/4_PBL5/PBL5_A2D/test_case/local_control/main/cacert.pem')
...
async def main():
    ...
    parser.add_argument('--name', dest='service_name', type=str, help='BLE Device Name / HTTP Server hostname or IP', default='')
