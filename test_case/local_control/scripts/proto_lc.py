...
idf_path = os.environ.get('IDF_PATH', 'C:/Espressif/frameworks/esp-idf-v5.5')
constants_pb2 = _load_source('constants_pb2', os.path.join(idf_path, 'components/protocomm/python/constants_pb2.py'))
local_ctrl_pb2 = _load_source('esp_local_ctrl_pb2', os.path.join(idf_path, 'components/esp_local_ctrl/python/esp_local_ctrl_pb2.py'))
