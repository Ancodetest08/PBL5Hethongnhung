...
static esp_err_t get_property_values(size_t props_count, const esp_local_ctrl_prop_t props[], esp_local_ctrl_prop_val_t prop_values[], void *usr_ctx) {
    int i = 0;
    ...
    for (i = 0; i < props_count; i ++) {
        ...
        if (!strncmp(PROPERTY_NAME_STATUS, props[i].name, strlen(props[i].name))) {
            ...
            prop_values[i].data = &light_status;
...
static esp_err_t set_property_values(size_t props_count, const esp_local_ctrl_prop_t props[], const esp_local_ctrl_prop_val_t prop_values[],void *usr_ctx) {
    int i = 0;
